...
A repository (repo for short) is a different project on its own. For example we have practice code and actual final project code in different repos.
To download a repo and actually commit changes to it, go to the repo online and click "Clone in Desktop."
